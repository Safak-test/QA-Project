...
def run_tests():
    ...
    """
    print("\n--- Rapor ve Sonuç Dizinlerini Temizle ---")
    # Test ve rapor dizinlerini temizle
    if os.path.exists("./allure-results"):
        print("allure-results dizini siliniyor...")
        shutil.rmtree("./allure-results")
    if os.path.exists("./allure-report"):
        print("allure-report dizini siliniyor...")
        shutil.rmtree("./allure-report")
    
    os.makedirs("./allure-results")
    print("allure-results dizini oluşturuldu.")
    ...
    try:
        ...
        # Genellikle bu komut kendi başına çalışır ve bir alt süreçte kalır,
        # bu yüzden 'check=True' kullanmak yerine doğrudan çağırmak daha iyidir.
